        ...
        <section className="relative pt-32 pb-12 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="mt-5 max-w-2xl border-l-2 border-brand-600 pl-4 text-sm text-slate-500 dark:text-slate-400">
              <p>
                {isEs
                  ? 'Juan Bv. es un desarrollador de softwarey fundador de Nexora Tech. Revisa estos contenidos desde la experiencia de proyectos web, automatización e IA para empresas en México.'
